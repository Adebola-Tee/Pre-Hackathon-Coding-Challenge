...
const Home = () => {
  return (
    <div className="max-w-full w-full h-fit justify-center flex md:flex-row flex-col bg-purple-300 pt-[70px] md:pt-32">
      <div className="md:pl-16 pl-10 pr-10">
        ...
        <PiStarFourFill
          size={20}
          color="#FFFFFF"
          className="md:m-10 ml-24 twinkle"
        ...
        <PiStarFourFill
          size={14}
          color="#808080"
          className="ml-[380px] md:hidden block twinkle"
          style={{ animation: "twinkle 2s infinite" }}
        />
        ...
        <img
          ...
          width={50}
          height={50}
          className="md:ml-[420px] ml-[280px]"
        />
        <div className="flex flex-col md:gap-5 gap-4 text-center md:text-left">
          <div>
            <h3 className="text-white md:text-7xl text-[40px] font-bold font-serif">
              getlinked Tech
            </h3>
            <h3 className="text-white md:text-[63px] text-[40px] font-bold font-serif">
          ...
          <div className="flex flex-row gap-4 justify-center">
            ...
            <PiStarFourFill
              size={10}
              color="#808080"
              className="ml-5 mt-3 md:hidden block twinkle"
              style={{ animation: "twinkle 2s infinite" }}
            />
          </div>
          ...
          <PiStarFourFill
            size={20}
            color="#808080"
            className="md:ml-[400px] md:mt-6 md:block hidden twinkle"
            style={{ animation: "twinkle 2s infinite" }}
          />
      ...
      <div className="flex flex-col">
        <div className="flex flex-col items-end md:mb-4 pr-4">
        ...
        <PiStarFourFill
          size={20}
          color="#808080"
          className="md:mt-5 md:ml-10 md:block hidden twinkle"
          style={{ animation: "twinkle 2s infinite" }}
        />
        ...
        <div className="relative">
          <img
            src={man}
            alt=""
            className="absolute md:w-[830px] w-full h-[700px]"
          />
          <img
            src={image}
            alt=""
            className="absolute md:w-[700px] w-full h-[640px] bg-none"
          />
        </div>
      </div>
    </div>
